...
class LandingPage extends React.Component {
    ...
    handleClick(e) {
        ...
        axios.get(`https://www.nokeynoshade.party/api/seasons/${selectedSeason}/lipsyncs`, {
        })
        .then(({ data }) => {
            this.setState({
    ...
    getSongArtistAPI(e1, e2) {
        ...
        axios({
            ...
            params: {
                reqUrl:`https://api.musixmatch.com/ws/1.1/matcher.lyrics.get`, 
                params: {
            ...
            <div className="wrapper clearfix">
                <div className="mainContainer">
                    ...
                    <div>
                        ...
                        <AnchorLink className="smoothscrollFromHeader" href="#seasonScroll" offset="15">
                            Sashay Away
                        </AnchorLink>
                    </div>
                    </div>
                        ...
                        <AnchorLink href="#songCardWrapperID" className="seasonDownButton">Lip Sync For Your Life</ AnchorLink>
                            </div>
                        </ul>
